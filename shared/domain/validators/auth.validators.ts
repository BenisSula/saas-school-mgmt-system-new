...
// Common fields
export const fullNameSchema = z.string().min(2, 'Name must be at least 2 characters long').trim();
...
export const allowedSelfRegisterRoles = ['student', 'teacher', 'admin'] as const;
