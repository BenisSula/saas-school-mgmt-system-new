...
const typeConfig = {
  teachers: {
    ...
    defaultDescription:
      'Get started by creating your first teacher account. Teachers can manage classes, mark attendance, and enter grades.',
  ...
  students: {
    ...
    defaultDescription:
      'Start managing your student roster by adding your first student. You can import multiple students at once using CSV.',
  ...
  hods: {
    ...
    defaultDescription:
      'Create HOD accounts to oversee departments and manage teachers. HODs can view department analytics and reports.',
  ...
  generic: {
    ...
    defaultDescription:
      'There are no items to display. Use filters to refine your search or create new items.',
...
function EmptyStateComponent({
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-xl border border-[var(--brand-border)] bg-[var(--brand-surface)]/50 p-12 text-center">
      <div className="mb-4 text-[var(--brand-muted)]">{displayIcon}</div>
      <h3 className="mb-2 text-xl font-semibold text-[var(--brand-surface-contrast)]">
        {displayTitle}
      </h3>
      <p className="mb-6 max-w-md text-sm text-[var(--brand-muted)]">{displayDescription}</p>
      {onAction && (
