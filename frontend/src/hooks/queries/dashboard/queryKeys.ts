...
export const dashboardKeys = {
  ...
  attendanceToday: (tenantId: string) =>
    [...dashboardKeys.root(tenantId), 'attendanceToday'] as const,

  activeSessions: (tenantId: string) =>
    [...dashboardKeys.root(tenantId), 'activeSessions'] as const,

  loginAttempts: (tenantId: string) => [...dashboardKeys.root(tenantId), 'loginAttempts'] as const,

  recentActivity: (tenantId: string) =>
    [...dashboardKeys.root(tenantId), 'recentActivity'] as const,
};
