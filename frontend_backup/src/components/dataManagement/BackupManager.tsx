            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {jobs.map((job) => (
                <tr key={job.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm">{formatFileSize(job.file_size_bytes)}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{job.storage_location}</td>
